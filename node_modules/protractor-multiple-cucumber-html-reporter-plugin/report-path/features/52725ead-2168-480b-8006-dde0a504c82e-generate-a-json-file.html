...
<head>
    ...
    <title>A custom page title</title>
    <!-- Bootstrap -->
...
<body>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <p class="navbar-text">You can adjust this report name</p>
            ...
            <p class="navbar-text">Feature:
                <small>Generate a JSON file</small>
            </p>
        </div>
    </nav>
...
<div class="x_content">
    <div class="dashboard-widget-content">
        <ul class="quick-list">
            ...
            <li>
                <span class="meta-data-title">chrome</span>
            ...
            <li>
                <span class="meta-data-title">osx</span>
                <span class="meta-data-data"></span>
            </li>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel" style="height: auto;">
      <div class="x_title">
        ...
        <h2>Scenario: <small>I want to generate a report</small></h2>
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    ...
                    <li>
                        ...
                        <span style=padding-right:5em>00:00:00.001</span>
                    </li>
      ...
      <div class="x_content" style="display: none;">
            ...
            <div class="scenario-step-container">
                ...
                <div class="text">
                    ...
                    I verified it
                            ...
                            <span class="duration">00:00:00.001</span>
        ...
        <div><p>A custom page footer</p></div>
