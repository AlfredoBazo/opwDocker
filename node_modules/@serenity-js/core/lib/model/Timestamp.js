...
class Timestamp extends tiny_types_1.TinyType {
    constructor(value = new Date()) {
        super();
        this.value = value;
        tiny_types_1.ensure(Timestamp.name, value, tiny_types_1.isDefined(), isInstanceOf(Date));
    }
    static fromJSON(v) {
...
function isInstanceOf(type) {
    return tiny_types_1.Predicate.to(`be an instance of ${type.name}`, (value) => value instanceof type);
}
