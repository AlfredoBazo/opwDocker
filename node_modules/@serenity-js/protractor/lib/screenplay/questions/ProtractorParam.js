 ...
 */
class ProtractorParam extends core_1.Question {
    /**
     * @param {@serenity-js/core/lib/screenplay~Answerable<string>} name
     */
    constructor(name) {
        super(io_1.formatted `the ${name} param specified in Protractor config`);
        this.name = name;
    }
    /**
     * @desc
     ...
     */
    static called(name) {
        return new ProtractorParam(name);
    }
    /**
     * @desc
    ...
    answeredBy(actor) {
        return actor.answer(this.name)
            .then(name => abilities_1.BrowseTheWeb.as(actor).param(name));
    }
}
